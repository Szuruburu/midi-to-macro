...
#Include %A_Script_Dir%\lib\MidiInAndGuiMonitor.ahk ; this file contains: the function to parse midi message into parts we can work with and a midi monitor.
#Include %A_Script_Dir%\lib\MidiRules.ahk              ; this file contains: Rules for manipulating midi input then sending modified midi output.
#Include %A_Script_Dir%\lib\MidiUnderTheHood.ahk    ; this file contains: (DO NOT EDIT THIS FILE) all the dialogs to set up midi ports and midi message handling.
